...
[
  ...
  { code: 'marlin',       name: 'Marlin',       country: 'ua', www: '',                           background_color: '#ffffff', catalog: '', phone: '',    email: '',    address: '' },
  ...
  { code: 'mvd',          name: 'MVD',          country: 'gr', www: 'mvd-retail.gr',              background_color: '#252525', catalog: '', phone: '',    email: '',    address: '' },
  { code: 'oceanic',      name: 'Oceanic',      country: 'us', www: 'oceanicworldwide.com',       background_color: '#ffffff', catalog: '', phone: '8882708595',    email: 'tac@huishoutdoors.com',    address: '' },
  { code: 'omer',         name: 'O.M.E.R.',     country: 'it', www: 'omersub.com',                background_color: '#ffffff', catalog: 'http://www.omersub.com/wp-content/themes/trackstore-child/assets/pdf/cataloghi/OMER_2021.pdf', phone: '+39039207881',    email: 'OMR-info@aqualung.com',    address: '14ème Rue | 06513 Carros, France' },
  ...
  { code: 'salvimar',     name: 'Salvimar',     country: 'it', www: 'salvimar.com',               background_color: '#ffffff', catalog: 'https://www.salvimar.com/downloads/Buyer%60s%20Guide%20SALVIMAR%202022_2023.pdf', phone: '',    email: 'info@salvimar.com',    address: 'Via G. Farina 2/4/6 16030 Casarza Ligure - Ge - Italy' },
  ...
  # {code: 'aruba',        name: 'Aruba',        country: 'tw', www: '',                      background_color: '#ffffff', catalog: '', phone: '',    email: '',    address: ''},
  # {code: 'ist',          name: 'IST',          country: 'tw', www: '',                      background_color: '#ffffff', catalog: '', phone: '',    email: '',    address: ''},
  # {code: '',      name: '',    country: '', www: '',                    background_color: '#ffffff', catalog: '', phone: '',    email: '',    address: ''},

...
Modification.create(code: '20001', prop1: '450', prop2:  '59', item_id: item1.id, part_codes: '01191,01171,01161', price: 19200, images: '0, 0, 0, 0, 0, 1, 4, 5, 6, 7, 8, 9, 0, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0')
Modification.create(code: '20003', prop1: '450', prop2: '207', item_id: item1.id, part_codes: '01191,01171,01161', price: 19200, images: '0, 0, 0, 0, 0, 1, 6, 7, 8, 4, 5, 9, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0, 0')
Modification.create(code: '20005', prop1: '600', prop2:  '59', item_id: item1.id, part_codes: '01192,01172,01162', price: 19200, images: '0, 0, 1, 2, 4, 5, 3, 3, 6, 7, 8, 9, 0, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0')
Modification.create(code: '20007', prop1: '600', prop2: '170', item_id: item1.id, part_codes: '01192,01172,01162', price: 19200, images: '0, 0, 1, 2, 4, 5, 3, 6, 7, 8, 3, 9, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0')
Modification.create(code: '20009', prop1: '600', prop2: '246', item_id: item1.id, part_codes: '01192,01172,01162', price: 19200, images: '0, 0, 1, 2, 4, 5, 6, 7, 8, 3, 3, 9, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0, 0')
Modification.create(code: '20011', prop1: '750', prop2:  '59', item_id: item1.id, part_codes: '01193,01173,01163', price: 20800, images: '0, 1, 2, 3, 4, 5, 3, 3, 6, 7, 8, 9, 0, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0')
Modification.create(code: '20013', prop1: '750', prop2: '170', item_id: item1.id, part_codes: '01193,01173,01163', price: 20800, images: '0, 1, 2, 3, 4, 5, 3, 6, 7, 8, 3, 9, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0')
Modification.create(code: '20015', prop1: '750', prop2: '246', item_id: item1.id, part_codes: '01193,01173,01163', price: 20800, images: '0, 1, 2, 3, 4, 5, 6, 7, 8, 3, 3, 9, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0, 0')
Modification.create(code: '20017', prop1: '900', prop2:  '59', item_id: item1.id, part_codes: '01194,01174,01164', price: 22400, images: '1, 2, 3, 4, 5, 3, 3, 3, 6, 7, 8, 9, 0, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0')
Modification.create(code: '20019', prop1: '900', prop2: '170', item_id: item1.id, part_codes: '01194,01174,01164', price: 22400, images: '1, 2, 3, 4, 5, 3, 3, 6, 7, 8, 3, 9, 0, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0')
Modification.create(code: '20021', prop1: '900', prop2: '246', item_id: item1.id, part_codes: '01194,01174,01164', price: 22400, images: '1, 2, 3, 3, 4, 5, 6, 7, 8, 3, 3, 9, 0, 0, 0, 0, 0, 0, 19, 20, 21, 0, 0, 0')

[
  {code: '01111', name: 'Катушка',                      item_id: item1.id, price: 2400, description: 'На катушку укладывается 20 метров линя толщиной 2 мм. Диаметр шпули 65 мм и полезная ширина 28 мм. Возможна установка для левши и для правши. Соответственно в кронштейне катушки предусмотрены 2 симметрично расположенных паза под размещение фильеры для линя, которая выполнена из нержавеющей стали и имеет с двух сторон плавные скругления в отверстии прохода линя, что предотвращает его повреждение в процессе эксплуатации. Затягивается катушка и расслабляется одним движением рычага. Рычаг затяжки и ручка намотки размещены с противоположных сторон и не мешают друг другу. Пластиковые детали катушки выполнены из ударопрочной жесткой пластмассы. В комплект поставки входят два крепежных винта из нержавеющей стали.'},
  ...
  {code: '01076', name: 'Кукан трос металл',            item_id: item1.id, price: 2560, description: 'Кукан предназначен для "парковки" добытой рыбы и "транспортирования" ее в процессе подводной охоты. Выпускается в двух вариантах - для пресной и соленой воды. Разница в материале троса - оцинкованный стальной или полимерный. Кукан состоит из эластичного пояса, замка и иглы с тросом. Замок крепится к эластичному поясу, игла вставляется в замок и соединена с тросом, второй конец которого крепится к этому же поясу. Последний одевается на торс подводного охотника независимо от остального снаряжения и при необходимости легко сбрасывается. Игла с тросом и замком образуют петлю, на которой и находится добытая рыба. После удачного выстрела игла при помощи одной руки высвобождается из замка. Затем этой иглой пронизывается рыба, освобождается гарпун, и игла снова застегивается. На игле в задней ее части расположен флажок, который служит упором для руки при пронизывании рыбы и не дает ей возможности сойти в случае если охотник случайно выронит иглу, не успев ее застегнуть. Тем не менее рыбу можно легко снять с кукана, расстегнув замок и перебросив флажок на другую сторону. Флажок устроен точно так же, как и в трезубце "Каюк". Точка крепления троса на эластичном поясе может перемещаться и петлю, на которой находится рыба, можно растянуть за спиной охотника, тем самым исключив зацепы за водоросли, тростник и коряги. Оригинальная конструкция пряжки обеспечивает надежную фиксацию кукана на поясе и быстрый сброс в случае экстренной необходимости одной свободной рукой. Конструкция кукана «Каюк» и пряжки патентована в России, Беларуси и Украине. При заказе указывайте объем по поясу или по груди в см в зависимости от места крепления кукана.'},
  {code: '01077', name: 'Кукан трос полимер',           item_id: item1.id, price: 2560, description: 'Кукан предназначен для "парковки" добытой рыбы и "транспортирования" ее в процессе подводной охоты. Выпускается в двух вариантах - для пресной и соленой воды. Разница в материале троса - оцинкованный стальной или полимерный. Кукан состоит из эластичного пояса, замка и иглы с тросом. Замок крепится к эластичному поясу, игла вставляется в замок и соединена с тросом, второй конец которого крепится к этому же поясу. Последний одевается на торс подводного охотника независимо от остального снаряжения и при необходимости легко сбрасывается. Игла с тросом и замком образуют петлю, на которой и находится добытая рыба. После удачного выстрела игла при помощи одной руки высвобождается из замка. Затем этой иглой пронизывается рыба, освобождается гарпун, и игла снова застегивается. На игле в задней ее части расположен флажок, который служит упором для руки при пронизывании рыбы и не дает ей возможности сойти в случае если охотник случайно выронит иглу, не успев ее застегнуть. Тем не менее рыбу можно легко снять с кукана, расстегнув замок и перебросив флажок на другую сторону. Флажок устроен точно так же, как и в трезубце "Каюк". Точка крепления троса на эластичном поясе может перемещаться и петлю, на которой находится рыба, можно растянуть за спиной охотника, тем самым исключив зацепы за водоросли, тростник и коряги. Оригинальная конструкция пряжки обеспечивает надежную фиксацию кукана на поясе и быстрый сброс в случае экстренной необходимости одной свободной рукой. Конструкция кукана «Каюк» и пряжки патентована в России, Беларуси и Украине. При заказе указывайте объем по поясу или по груди в см в зависимости от места крепления кукана.'},
  {code: '01121', name: 'Площадка GoPro',               item_id: item1.id, price:  880, description: 'Площадка для бокового крепления подводного бокса камеры GoPro. С ее помощью камеру можно установить в четырех позициях – слева или справа и в прямом и перевернутом положении. Возможна установка камеры объективом в обратную сторону. Площадка выполнена из ударопрочного пластика и поставляется с двумя крепежными винтами из нержавеющей стали.'},
  {code: '01131', name: 'Площадка Sony',                item_id: item1.id, price: 1200, description: 'Площадка для бокового крепления подводного бокса камеры Sony. С ее помощью камеру можно установить сбоку справа или сбоку слева, но в перевернутом положении. Площадка выполнена из ударопрочного пластика и поставляется с двумя крепежными винтами из нержавеющей стали.'},
  {code: '01146', name: 'Кронштейн фонаря',             item_id: item1.id, price: 1200, description: 'Кронштейн предназначен для крепления подводного фонаря с диаметром корпуса 24 или 32 мм. Сначала фонарь вставляется в кронштейн и поджимается тремя винтами через эластичную силиконовую прокладку, которая при поджиме своей поверхностью облегает корпус фонаря и обеспечивает необходимое усилие для его надежного удержания. Затем кронштейн крепится в одном из пазов универсального модуля с помощью двух винтов из нержавеющей стали, которые предусмотрены в комплекте поставки. Кронштейн выполнен из ударопрочного пластика.'},
  {code: '01161', name: 'Футляр Премиум 450/600',       item_id: item1.id, price: 2240, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип.мВ стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, двух трезубцев, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Снаружи предусмотрен прозрачный карман для визитки, чтобы не перепутать ваш комплект с другим.'},
  {code: '01162', name: 'Футляр Премиум 450/600',       item_id: item1.id, price: 2240, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип.мВ стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, двух трезубцев, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Снаружи предусмотрен прозрачный карман для визитки, чтобы не перепутать ваш комплект с другим.'},
  {code: '01163', name: 'Футляр Премиум 750',           item_id: item1.id, price: 2400, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип.мВ стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, двух трезубцев, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Снаружи предусмотрен прозрачный карман для визитки, чтобы не перепутать ваш комплект с другим.'},
  {code: '01164', name: 'Футляр Премиум 900',           item_id: item1.id, price: 2560, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип.мВ стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, двух трезубцев, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Снаружи предусмотрен прозрачный карман для визитки, чтобы не перепутать ваш комплект с другим.'},
  {code: '01171', name: 'Футляр Компакт 450',           item_id: item1.id, price: 1600, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип. В стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, одного трезубца, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Отличается от футляра "Премиум" меньшим размером по ширине за счет более компактного размещения составляющих комплекта.'},
  {code: '01172', name: 'Футляр Компакт 600',           item_id: item1.id, price: 1680, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип. В стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, одного трезубца, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Отличается от футляра "Премиум" меньшим размером по ширине за счет более компактного размещения составляющих комплекта.'},
  {code: '01173', name: 'Футляр Компакт 750',           item_id: item1.id, price: 1760, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип. В стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, одного трезубца, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Отличается от футляра "Премиум" меньшим размером по ширине за счет более компактного размещения составляющих комплекта.'},
  {code: '01174', name: 'Футляр Компакт 900',           item_id: item1.id, price: 1840, description: 'Футляр защищает ваш комплект от повреждений в процессе транспортировки и хранения. Футляр выполнен из материала камуфляжной расцветки и похож на большую косметичку, на лицевой стороне которой вышит фирменный логотип. В стенках находится жесткий листовой поролон, который придает футляру форму и защищает содержимое от механических повреждений. Снаружи расположен карман под «молнией» для документов и инструкции. Внутри предусмотрено место для ружья, насоса, двух гарпунов, одного трезубца, зарядного упора, нескольких одиночных наконечников, инструмента, а также имеется прозрачный карман для всяких мелочей. Для ограничения доступа детей к содержимому футляра его можно закрыть, скрепив две застежки на "молнии" маленьким багажным замком (в комплекте с футляром не идет). Отличается от футляра "Премиум" меньшим размером по ширине за счет более компактного размещения составляющих комплекта.'},
  {code: '01191', name: 'Чехол 450',                    item_id: item1.id, price:  720, description: 'Чехол защищает ваш комплект от повреждений в процессе транспортировки и хранения. Чехол изготовлен в упрощенном бюджетном варианте из материала камуфляжной расцветки, на лицевой стороне которой вышит фирменный логотип. Внутри предусмотрен отдельный карман для ружья, насоса, двух гарпунов, трезубца и инструкции. Все перечисленное помещается внутрь через боковой клапан на "липучке". Снаружи имеется карман под "молнией" для одиночных наконечников, инструмента и мелких запасных частей.'},
  {code: '01192', name: 'Чехол 600',                    item_id: item1.id, price:  800, description: 'Чехол защищает ваш комплект от повреждений в процессе транспортировки и хранения. Чехол изготовлен в упрощенном бюджетном варианте из материала камуфляжной расцветки, на лицевой стороне которой вышит фирменный логотип. Внутри предусмотрен отдельный карман для ружья, насоса, двух гарпунов, трезубца и инструкции. Все перечисленное помещается внутрь через боковой клапан на "липучке". Снаружи имеется карман под "молнией" для одиночных наконечников, инструмента и мелких запасных частей.'},
  {code: '01193', name: 'Чехол 750',                    item_id: item1.id, price:  880, description: 'Чехол защищает ваш комплект от повреждений в процессе транспортировки и хранения. Чехол изготовлен в упрощенном бюджетном варианте из материала камуфляжной расцветки, на лицевой стороне которой вышит фирменный логотип. Внутри предусмотрен отдельный карман для ружья, насоса, двух гарпунов, трезубца и инструкции. Все перечисленное помещается внутрь через боковой клапан на "липучке". Снаружи имеется карман под "молнией" для одиночных наконечников, инструмента и мелких запасных частей.'},
  {code: '01194', name: 'Чехол 900',                    item_id: item1.id, price:  960, description: 'Чехол защищает ваш комплект от повреждений в процессе транспортировки и хранения. Чехол изготовлен в упрощенном бюджетном варианте из материала камуфляжной расцветки, на лицевой стороне которой вышит фирменный логотип. Внутри предусмотрен отдельный карман для ружья, насоса, двух гарпунов, трезубца и инструкции. Все перечисленное помещается внутрь через боковой клапан на "липучке". Снаружи имеется карман под "молнией" для одиночных наконечников, инструмента и мелких запасных частей.'},
  {code: '01021', name: 'Двузубец',                     item_id: item1.id, price: 2000, description: 'Двузубец изготавливается под резьбу международного стандарта М7. Диаметр зубов 7 мм. Глубина проникновения 230 мм. Расстояние от флажка до кончика зуба 35 мм. Расстояние по осям между крайними зубами 43 мм. Флажки выполнены из пружинной нержавеющей проволоки диаметром 2 мм. Остальные элементы изготовлены из упругой нержавеющей стали. Кончики зубов выполнены трехгранными и имеют большую проникающую способность по сравнению с круглыми. На фото положение флажков во время выстрела, удержания и снятия. Перед очередным заряжанием не забудьте вернуть флажки в исходное положение.'},
  {code: '01026', name: 'Трезубец',                     item_id: item1.id, price: 2400, description: 'Трезубец изготавливается под резьбу международного стандарта М7. Диаметр зубов 6 мм. Длина центрального зуба 200 мм. Расстояние от флажка до кончика зуба 35 мм. Расстояние по осям между крайними зубами 62 мм. Флажки выполнены из пружинной нержавеющей проволоки диаметром 2 мм. Остальные элементы изготовлены из упругой нержавеющей стали. Кончики зубов выполнены трехгранными и имеют большую проникающую способность по сравнению с круглыми. Положение флажков во время выстрела, удержания и снятия. Перед очередным заряжанием не забудьте вернуть флажки в исходное положение.'},
  {code: '01031', name: 'Пятизубец',                    item_id: item1.id, price: 2880, description: 'Пятизубец изготавливается под резьбу международного стандарта М7. Диаметр среднего и крайних зубов 6 мм. Диаметр промежуточных зубов 5 мм.  Длина центрального зуба 200 мм. Расстояние от флажка до кончика зуба 35 мм. Расстояние по осям между крайними зубами 100 мм. Флажки выполнены из пружинной нержавеющей проволоки диаметром 2 мм. Остальные элементы изготовлены из упругой нержавеющей стали. Кончики среднего и крайних зубов выполнены трехгранными и имеют большую проникающую способность по сравнению с круглыми. В основном применяется при охоте на угря. Положение флажков во время выстрела, удержания и снятия смотрите на фото. Перед очередным заряжанием не забудьте вернуть флажки в исходное положение.'},
...
Modification.create(code: 'kf_024', prop1: 'Mакси',      item_id: item10.id, part_codes: '', price: 13000, image_url: 'https://www.kf-fish.ru/gallery_gen/408df66c24c700d396da0243e19e7d47.jpg')
...
Modification.create(code:  '20', prop1:  '20',     item_id: item11.id, part_codes: 'vl20case,vl20harp',                                       price:  7000, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639444703167._szw480h1280_.jpg')
Modification.create(code:  '40', prop1:  '30',     item_id: item11.id, part_codes: 'vl30harp',                                                price:  7800, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639442770204._szw480h1280_.jpg')
Modification.create(code:  '40', prop1:  '40',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl40harp,vl230popl',                      price:  8600, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639442770204._szw480h1280_.jpg')
Modification.create(code:  '50', prop1:  '50',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl50harp,vl230popl,vl360popl',            price:  9400, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639446306436._szw480h1280_.jpg')
Modification.create(code:  '60', prop1:  '60',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl60harp,vl230popl,vl360popl,vl400popl',  price: 10200, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639443401550._szw1280h1280_.jpg')
Modification.create(code:  '70', prop1:  '70',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl70harp,vl230popl,vl360popl,vl400popl',  price: 11000, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639443401557._szw1280h1280_.jpg')
Modification.create(code:  '80', prop1:  '80',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl80harp,vl230popl,vl360popl,vl400popl',  price: 11800, image_url: '')
Modification.create(code:  '90', prop1:  '90',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl90harp,vl230popl,vl360popl,vl400popl',  price: 12600, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639448167561._szw1280h1280_.jpg')
Modification.create(code: '100', prop1: '100',     item_id: item11.id, part_codes: 'vl60kat,vl80kat,vl100harp,vl230popl,vl360popl,vl400popl', price: 13400, image_url: 'http://cdn.simplesite.com/i/29/cb/285415632998877993/i285415639446151407._szw1280h1280_.jpg')

Part.create(code: 'vl20case',  name: 'Кобура',       item_id: item11.id, price: 2000, description: '20')
Part.create(code: 'vl20harp',  name: 'Гарпун 20',    item_id: item11.id, price:  800, description: '20')
Part.create(code: 'vl30harp',  name: 'Гарпун 30',    item_id: item11.id, price:  900, description: '30')
Part.create(code: 'vl40harp',  name: 'Гарпун 40',    item_id: item11.id, price: 1000, description: '40')
Part.create(code: 'vl50harp',  name: 'Гарпун 50',    item_id: item11.id, price: 1100, description: '50')
Part.create(code: 'vl60harp',  name: 'Гарпун 60',    item_id: item11.id, price: 1200, description: '60')
Part.create(code: 'vl70harp',  name: 'Гарпун 70',    item_id: item11.id, price: 1300, description: '70')
Part.create(code: 'vl80harp',  name: 'Гарпун 80',    item_id: item11.id, price: 1400, description: '80')
Part.create(code: 'vl90harp',  name: 'Гарпун 90',    item_id: item11.id, price: 1500, description: '90')
Part.create(code: 'vl100harp', name: 'Гарпун 100',   item_id: item11.id, price: 1600, description: '100')
...
Part.create(code: 'vl_cam',    name: 'Крепление для камеры',   item_id: item11.id, price: 600, description: 'Три оси вращения.')

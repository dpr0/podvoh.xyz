...
Modification.create(code: '100', prop1: '100',     item_id: item11.id, part_codes: 'vl_manok,vl_zar,vl60kat,vl80kat,vl100harp,vl230popl,vl360popl,vl400popl,vl600popl', price: 14_000, image_url: 'https://taplink.st/p/e/2/9/8/34242807.jpg', text: 'самое мощное ружьё из линейки ружей Vlanik.Предназначено для дальней стрельбы... При габаритной длине 100 см поражающая дальность стрельбы до 8 метров.')
